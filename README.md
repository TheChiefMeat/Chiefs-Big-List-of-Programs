...
I've started to use [Chocolatey](https://chocolatey.org/) to install most of my applications. Any applications that have a chocolately recently updated release available will have a ✅ next to them (Current coverage is about 24%).
#
